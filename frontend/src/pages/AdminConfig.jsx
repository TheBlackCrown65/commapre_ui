...
export default function AdminConfig() {
    ...
    const generalKeys = ['max_image_size_mb', 'max_images_per_flow', 'max_folder_depth', 'max_queue_size', 'max_jobs_per_department', 'max_dashboard_jobs', 'max_flow_note_length', 'worker_concurrency', 'offline_suspend_days', 'mismatch_threshold_percent', 'job_retention_days'];

                            ...
                            >
                                <div className="grid grid-cols-3 gap-1.5 sm:gap-2 lg:gap-3">
                                    ...
                                    <div className="flex flex-col gap-3 sm:gap-3.5">
                                        ...
                                        <div className="bg-slate-50/80 rounded-xl p-1.5 sm:p-2 border border-slate-200 shadow-sm flex items-center justify-center min-h-[420px] lg:min-h-[580px]">
                                            <img
                                                src={previewComparison.b_img}
                                                alt="Reference (Master)"
                                                className="max-h-[68vh] w-auto max-w-full object-contain rounded border border-black shadow-sm bg-white"
                                                draggable="false"
                                            />
                                        </div>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between mt-2">
                                        ...
                                        {(job.status === 'QUEUED' || job.status === 'PROCESSING') && (() => {
                                            ...
                                            const pct = pData?.percent !== undefined ? pData.percent : 0;
                                            return (

...
export default function RunTest() {
    ...
    const [compareByOrder, setCompareByOrder] = useState(true);
            ...
            <div className="bg-white p-3 sm:p-4 lg:p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col gap-3 shrink-0">
                <div className="flex items-center justify-between gap-3">
                    ...
                    <button
                        ...
                        className={clsx(
                            "shrink-0 ml-auto flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg font-bold text-white transition-all shadow-md text-sm whitespace-nowrap",

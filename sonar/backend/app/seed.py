...
def seed_system_configs():
    ...
    default_configs = [
        ...
        {"key": "mismatch_threshold_percent", "value": "30", "description": "Percentage of image difference before flagging as PAGE MISMATCH"},
        {"key": "job_retention_days", "value": "30", "description": "Number of days to keep job history and output files"}
    ]
